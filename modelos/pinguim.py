...
class Pinguim(Personagem):
    def __init__(self, nome: str):
        super().__init__(nome, papel="🐧 VILÃO (PINGUIM)")

    def realizar_acao_noturna(self, jogo_contexto):
        print(f"\n☂️ [GUARDA-CHUVA SUBVERSIVO] Vez do Pinguim agir...")
        ...
        escolha = ler_escolha_valida("\n(Pinguim, digite o número da sua escolha em segredo): ", len(vitimas))
        
        if escolha == 0:
            print("\nTurno pulado. Nenhum ataque realizado pelo Pinguim.")
            return
